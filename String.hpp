...
class String {
 public:
  ...
  int32_t Find(const String& substr) const;
  ...
  /// Функция возвращает сколько памяти можно выделить
  /// <returns>Возвращаем сколько памяти можно выделить</returns>
